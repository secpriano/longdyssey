namespace ExceptionHandler
{
    public class ErrorResponse : Exception
    {
        ...
        public static string GetErrorMessage(ErrorType errorType) => errorType switch
        {
            ...
            ErrorType.FlightScheduleDatesOverlap => "Sorry, the flight schedule dates you have selected overlap with an existing flight schedule. Please try again with different search criteria.",
            _ => "Unknown error",
        };
    }
}
